...
class Asanpardakht extends PortAbstract implements PortInterface
{
    ...
    protected $asanpardakhstInfo=new AsanpardakhstInfo();
...
//            $this->callbackUrl = $this->config->get('gateway.asanpardakht.callback-url');
            $this->callbackUrl = $this->asanpardakhstInfo->callback-url;
    ...
    protected function sendPayRequest()
    {
       ...
       // $username = $this->config->get('gateway.asanpardakht.username');
        $username =$this->asanpardakhstInfo->username;
        //$password = $this->config->get('gateway.asanpardakht.password');
        $password =$this->asanpardakhstInfo->password;
        ...
        $params = array(
            'merchantConfigurationID' => $this->asanpardakhstInfo->merchantConfigId,
...
//        $password = $this->config->get('gateway.asanpardakht.password');
    ...
    private function encrypt($string = "")
    {
        ...
        $key = $this->asanpardakhstInfo->key;
        $iv = $this->asanpardakhstInfo->iv;
